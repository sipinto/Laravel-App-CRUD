...
## 11. 한글화 하기
- 메세지 한글화 하기
  - 유효성 검사 메세지 뿐만 아니라 다른 메세지들을 한글화 하려면
  - 프로젝트 안으로 설정 파일을 가져와야 함
  - 해당 명령어

    `php artisan lang:publish`
  - 입력 후 lang 디렉터리 확인 가능 
  - en 디렉터리 복사 후 kor 폴더 하나 생성 
  - config/app.php 접속 후 
  
    `'locale' => 'en'` 를
    `'locale' => 'ko'` 로 바꾸면 설정 끝
...
## 40. 라우트 모델 바인딩 키 커스터 마이징

## 41. username 수정 기능 추가
