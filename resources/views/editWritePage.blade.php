    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="writeWrap">
            ...
            <form id="articleForm" action="{{ route('editPage', ['category' => $category, 'pId' => $articles->id]) }}"" method="POST" class="form-container" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                  <img id="preview" src="{{ asset($articles->imgAdd) }}" alt="Image Preview" style="display:none;">
                </div>
                <div class="buttonList">
                    <a href="{{ url('/main') }}" class="btn btn-secondary cancelButton">취소</a>
                   
                    <button type="submit" class="btn btn-primary writeButton">글수정</button>
